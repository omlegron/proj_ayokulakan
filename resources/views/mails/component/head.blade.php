...
<head>
  ...
  <body style="margin: 0; padding: 0;">
    <table align="center" cellpadding="0" cellspacing="0" width="800" style="border:1px solid green">
     <tr style="border:2px solid green">
       <td align="center" bgcolor="#f0f0f0" style="padding-top: 10px;padding-bottom:10px;">
        <img src="{{ url('img/backgrounds/logos.png') }}" alt="Ayokulakan" width="250" style="display: block;" />
       </td>
     </tr>
     <tr>
       <td bgcolor="#ffffff" style="height: 100px;background-color: #ff750fd1;">
         <div style="text-align: center;margin-top: 10px;margin-bottom: 10px">
           <img src="{{ url('img/email.png') }}" width="125"><br>
           <p style="color: white;font-size: 25px">Pesan Dari Ayokulakan.com</p>
     ...
     <tr>
       <td bgcolor="#f0f0f0" style="padding: 40px 30px 40px 30px;">
         <div style="position:relative; min-height:500px">
           <div style="background: url({{ url('img/backgrounds/logos1.png') }}) no-repeat center center; background-size: contain; opacity:.05; position: absolute; display: block; height: 100%; width:100%">&nbsp;</div>
     ...
     <tr>
       <td bgcolor="#2cb55d" style="padding: 30px 30px 30px 30px;color:#ffffff;">
         <table border="0" cellpadding="0" cellspacing="0" width="100%">
          <tr>
            <td style="color: #ffffff; font-family: Arial, sans-serif; font-size: 14px;">
              &copy; Ayokulakan, {{ date('Y') }}
            </td>
          </tr>
         </table>
       </td>
