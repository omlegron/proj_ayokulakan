		...
		<table class="ui table" style="width: 100%;">
			<tr>
				<td class="center aligned" style="">
					<center style="font-size: 13px"><b><small>Laporan Booking Hotel</small></b></center>
				...
				<tbody>
					<tr>
						<td style="width:100px;border:1px solid black !important;">
							<ul>
                              <li>- Tanggal Boking : {{ $record->bookingDate or '' }}</li>
                              <li>- Nomor Revarasi : {{ $record->reservationNo or '' }}</li>
                              <li>- Nama Kamar : {{ $record->roomName or '' }}</li>
                              <li>- Nomor Ruangan / Kamar : {{ $record->roomNum or '' }}</li>
                              <li>- Tipe Ruangan / Kamar : {{ $record->roomType or '' }}</li>
                              <li>- Check In : {{ $record->checkInDate or '' }}</li>
                              <li>- Check Out : {{ $record->checkOutDate or '' }}</li>
                              <li>- Request Description : {{ $getBooking->bookingDetail->requestDescription or '' }}</li>
                              <li>- Breakfast : {{ $record->breakfast or '' }}</li>
                            </ul>
						</td>
					</tr>
				</tbody>
