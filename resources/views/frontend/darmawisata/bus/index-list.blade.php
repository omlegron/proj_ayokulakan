...
<div class="btn-toolbar mb-3" role="toolbar" aria-label="Toolbar with button groups">
    ...
    <div class="input-group" style="margin-bottom: 5px;">
        <input type="text" name="filter[bus]" class="form-control" placeholder="Nama Bus" aria-label="" aria-describedby="">
    </div>&nbsp;
    <div class="input-group" style="margin-bottom: 5px;">
        <input type="text" name="filter[originTerminal]" class="form-control" placeholder="Keberangkatan" aria-label="" aria-describedby="">
    </div>&nbsp;
    <div class="input-group" style="margin-bottom: 5px;">
        <input type="text" name="filter[destinationTerminal]" class="form-control" placeholder="Kedatangan" aria-label="" aria-describedby="">
    </div>&nbsp;
