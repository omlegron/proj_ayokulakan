						...
						<div class="product-info">
							...
							<div class="stock-container info-container m-t-10">
								<div class="row">
									...
									<div class="col-sm-12">
										<div class="stock-box">
											@if(isset($record->user->lapak->id))
											<span class="label"><b>Chat Sekarang</b></span>
											<div class="no-padding social">
								                <ul class="link">
								                    <li class="chats pull-left"><a target="_blank" rel="nofollow" href="{{ url('chat-sewa?toko_barang='.$record->id.'&toko='.$record->user->lapak->id) }}" target="_blank" title="Facebook"></a></li>
								                </ul>
											</div>
											@endif
										</div>	
									...
									<div class="col-sm-9">
										<div class="stock-box">
											<span class="value">{{ $record->user->lapak->nama_lapak or '-' }}</span>
										</div>	
									</div>
									<div class="col-sm-2">
										<div class="stock-box">
									...
									<div class="col-sm-9">
										<div class="stock-box">
											<span class="value"> {{ $record->kota->kota or '-'  }}</span>
										</div>	
									</div>
									<div class="col-sm-12">
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-8">
										<div class="price-box">
											<span class="price">Rp. {{ number_format($record->harga_sewa, 2, ',', '.')  }}</span>
