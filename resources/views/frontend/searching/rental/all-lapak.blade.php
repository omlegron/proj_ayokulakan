...
<div class="terms-conditions-page">
    <div class="row">
        <div class="col-md-12">
            <h3 class="section-title" style="margin-top: 20px">All Lapak</h3>
            <div class="col-md-12">
                <div class="row">
                    @if(count($record) > 0)
                    @foreach($record as $k => $v)
                    <div class="col-6 col-xs-6 col-md-2 wow fadeInUp animated" id="slick-disc-items" style="height: 320px" >
                        <div class="products">
                            <div class="product">
