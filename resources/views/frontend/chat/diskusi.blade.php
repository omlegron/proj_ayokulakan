            ...
            <div id="product-tabs-slider" class="scroll-tabs wow fadeInUp">
              <div class="more-info-tab clearfix ">
                <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link" id="home-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="home" aria-selected="true"><h3>Diskusi</h3></a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" id="home-tab" data-toggle="tab" href="#bank" role="tab" aria-controls="home" aria-selected="true"><h3>Produk Saya</h3></a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" id="home-tab" data-toggle="tab" href="#ganti-pass" role="tab" aria-controls="home" aria-selected="true"><h3>Mengikuti</h3></a>
                  </li>
                </ul>
              </div>
            </div>
