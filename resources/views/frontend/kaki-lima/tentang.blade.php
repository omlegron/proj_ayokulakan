                        ...
                        <div id="page_1">
                            ...
                            <div id="id1-2">
                                ...
                                <p class="p1 ft3 text-justify">
                                    ...
                                    serta informasi lokasi kepada pembeli. Ayokulakan memberikan informasi lokasi penjual yang
                                    terdekat dan pembeli bisa memesan barang melalui aplikasi Ayokulakan.com. Sehingga
                                    mempermudah proses jual beli.
                                </p>
                                <p class="p3 ft2">1.<span class=""> </span>Berikut adalah syarat dan ketentuannya :</p>
                                <div class="pl-3" style="padding: 0px 10px">    
                                    <p class="p1 ft3 text-justify">A.<span class="_ _1"> </span>Semua kaki lima, bisa bergabung dengan menu kaki lima Ayokulakan.com. Perlu diingat, </p>
                                    <p class="p1 ft3 text-justify">produk yang dijual adalah ready stock atau bukan produk pre-order.</p>
                                    <p class="p1 ft3 text-justify">B.<span class="_ _1"> </span>Warung makan  yang tidak memiliki meja atau tempat untuk makan di tempat bisa </p>
                                    <p class="p1 ft3 text-justify">bergabung dengan Ayokulakan.com, dengan catatan memiliki penanda berupa spanduk </p>
                                    <p class="p1 ft3 text-justify">atau plang yang mempermudah Kurir untuk menemukan alamat.</p>
                                    
                                    <p class="p1 ft3 text-justify">C.<span class="_ _1"> </span>Anda dapat menjual semua jenis makanan, minuman, produk olahan dll, namun harus </p>
                                    <p class="p1 ft3 text-justify">sesuai dengan peraturan pemerintah.</p>
                                    <p class="p1 ft3 text-justify">D.<span class="_ _1"> </span>Foto tempat usaha atau tempat lokasi.</p>
                                    <p class="p1 ft3 text-justify">E.<span class="_ _1"> </span>Foto ktp.</p>
                                    <p class="p1 ft3 text-justify">F.<span class="_ _1"> </span>Swafoto.</p>
                                </div>
                                <p class="p3 ft2">2.<span class="_ _2"> </span>Keuntungan bergabung menjadi kaki lima di Ayokulakan.com.</p>
                                <div style="padding: 0px 10px">
                                    <p class="p1 ft3 text-justify">A.<span class="_ _1"> </span>Anda bisa menggunakan aplikasi ayokulakan.com untuk melihat pesanan jika ada orang ingin </p>
                                    <p class="p1 ft3 text-justify">membeli produk jualan.</p>
                                    <p class="p1 ft3 text-justify">B.<span class="_ _1"> </span>Anda dapat  melihat pedagang kaki lima yang ada disekitar lokasi tempat anda berada, </p>
                                    <p class="p1 ft3 text-justify">melalui menu peta maps kaki lima.</p>
                                    <p class="p1 ft3 text-justify">C.<span class="_ _1"> </span>Traksasi lebih mudah dan aman.</p>
                                    <p class="p1 ft3 text-justify">D.<span class="_ _1"> </span>Pengiriman barang ke pembeli bisa cepat.</p>
                                </div>
                                <p class="p3 ft2">3.<span class="_ _2"> </span>Testimoni dari pembeli ke penjual </p>
                                <div style="padding: 0px 10px">
                                    <p class="p1 ft3 text-justify">A.<span class="_ _1"> </span>Memberikan bintang kepada penjual .</p>
                                    <p class="p1 ft3 text-justify">B.<span class="_ _1"> </span>Memberikan komentar tentang produk yang di jualnya.</p>
                                    <p class="p1 ft3 text-justify">C.<span class="_ _1"> </span>Mengupload foto barang yang sudah sampai. </p>
                                    <p class="p1 ft3 text-justify">D.<span class="_ _1"> </span>Kualitas produk.</p>
                                    <p class="p1 ft3 text-justify">E.<span class="_ _1"> </span>Harga produk yang bersaing. </p>
                                </div>
                                <div id="id1_2">
