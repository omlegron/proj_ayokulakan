        ...
        <div class="col col-sm-8 col-lg-12">
            <div class="filter-tabs">
                <ul id="filter-tabs" class="nav nav-tabs nav-tab-box nav-tab-fa-icon">
                    <li class="active">
                        <a data-toggle="tab" href="#grid-container" style="font-size: 20px;"><i class="icon fa fa-th-large " style="color: #16a70cbc"></i><span style="font-weight: bold">PRODUK PERIKANAN & PETERNAKAN</span></a>
                    </li>
                </ul>
            </div><!-- /.filter-tabs -->
        </div><!-- /.col -->
    ...
    <div id="myTabContent" class="tab-content category-list">
        <div class="tab-pane active " id="grid-container">
            <div class="category-product">
                <div class="row" id="slick-buat" style="margin-left: 0">
                    @if(count($perikananPeternakan) > 0)
                    @foreach($perikananPeternakan as $k => $v)
                    <div class="col-6 col-xs-6 col-md-2 wow fadeInUp animated" style="visibility: visible; animation-name: fadeInUp;width:207;height: 300px" id="slick-buat-items">
                        <div class="products">
                            <div class="product">
                ...
                <strong class="buat-kanan" style=""><i class="glyphicon glyphicon-chevron-left"></i></strong>
                 <strong class="buat-kiri"><i class="glyphicon glyphicon-chevron-right"></i></strong>
            </div>
        </div>
    </div>
</div>
