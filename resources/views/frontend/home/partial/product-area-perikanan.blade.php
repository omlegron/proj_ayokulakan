        ...
        <div class="col col-sm-8 col-lg-12">
            <div class="filter-tabs">
                <ul id="filter-tabs" class="nav nav-tabs nav-tab-box nav-tab-fa-icon">
                    <li class="active">
                        <a data-toggle="tab" href="#grid-container" style="font-size: 20px;"><i class="icon fa fa-th-large" style="color: #16a70cbc"></i><span style="font-weight: bold">BUAT KAMU</span></a>
                    </li>
                </ul>
            </div><!-- /.filter-tabs -->
        </div><!-- /.col -->
        ...
        <div class="tab-pane active " id="grid-container">
            <div class="category-product">
                <div class="row" id="slick-buat" style="margin-left: 0">
                    @if(count($perikanan) > 0)
                    @foreach($perikanan as $k => $v)
