						...
						<div class="product-info">
							...
							<div class="stock-container info-container m-t-10">
								<div class="row">
									...
									<div class="col-sm-12">
										<div class="stock-box">
											<span class="label"><b>Chat Sekarang</b></span>
											<div class="no-padding social">
								                <ul class="link">
								                    <li class="chats pull-left"><a target="_blank" rel="nofollow" href="{{ url('chat?toko_barang='.$record->id.'&toko='.$record->id_trans_lapak) }}" target="_blank" title="Facebook"></a></li>
								                </ul>
								            </div>
										</div>
									</div>
									...
									<div class="col-sm-12">
										<div class="stock-box">
											<span class="label"><b>Kategori</b> : {{ $record->kategoriBarang->kat_nama or '0' }}</span>
										</div>
									</div>
									<div class="col-sm-2">
										<div class="stock-box">
									...
									<div class="col-sm-12">
										...
										<div class="no-padding social">
							                <ul class="link">
							                    ...
							                    <li class="whatshap pull-left"><a target="_blank"  href="https://web.whatsapp.com/send?text={{url('sc/barang/'.$record->id)}}" data-action="share/whatsapp/share"></a></li>
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									<div class="col-sm-8">
										<div class="price-box">
											<span class="price">Rp. {{ number_format($record->harga_barang, 2, ',', '.') }}</span>
							...
							<div class="quantity-container info-container">
								<div class="row">
									...
									<div class="col-sm-2">
										<div class="cart-quantity">
											<div class="quant-input">
								                <form action="#">
												<input class="quantity mr-40" min="1" value="1" type="hidden" name="quantity">
											</form>
									...
									<div class="col-sm-7">
										<a href="javascript:void(0)" class="btn btn-primary ampass add-cart" data-item="{{ $record->id or '' }}" data-type="img_barang"><i class="fa fa-shopping-cart inner-right-vs"></i> Masukan Ke Keranjang</a>
									</div>
								</div>
							</div>
						</div>
