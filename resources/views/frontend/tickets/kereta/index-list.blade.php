...
<div class="btn-toolbar mb-3" role="toolbar" aria-label="Toolbar with button groups">
    <div class="input-group" style="margin-bottom: 5px;">
        <input type="text" name="filter[tr_id]" class="form-control" placeholder="Booking Code" aria-label="" aria-describedby="">
    </div>&nbsp;
    <div class="input-group" style="margin-bottom: 5px;">
        <input type="text" name="filter[trainName]" class="form-control" placeholder="Nama Bus" aria-label="" aria-describedby="">
    </div>&nbsp;
    <div class="input-group" style="margin-bottom: 5px;">
        <input type="text" name="filter[org]" class="form-control" placeholder="Keberangkatan" aria-label="" aria-describedby="">
    </div>&nbsp;
    <div class="input-group" style="margin-bottom: 5px;">
        <input type="text" name="filter[dest]" class="form-control" placeholder="Kedatangan" aria-label="" aria-describedby="">
    </div>&nbsp;
