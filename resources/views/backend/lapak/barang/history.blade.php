							...
							<tbody id="body">
								...
								@foreach ($record as $item)
									<tr>
										...
										<td><a href="{{ url("history-trans/$item->trans_transaksi_id/detail") }}" data-toggle="tooltip" data-placement="" title="Proses Data" data-id="{{ $item->trans_transaksi->id }}" class="ui mini btn btn-sm btn-success button"><i class="fa fa-eye"></i></a></td>
									</tr>
									<?php $no++ ?>
								@endforeach
							</tbody>
