			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="form-group">
						...
						<input type="text" name="kode_pos" class="form-control" placeholder="Kode Pos" required="" value="{{ $record->kode_pos or '' }}" maxlength="13" minlength="10" oninput="this.value= this.value.replace(/[^0-9.,]/g, '').replace(/(\..*)\.,/g, '$1')">
					</div>	
					<div class="form-group">
						<label for="">No HP Lapak</label>
						<input type="text" name="phone" class="form-control" placeholder="No HP Lapak" required="" value="{{ $record->phone or '' }}" maxlength="13" minlength="10" oninput="this.value= this.value.replace(/[^0-9.,]/g, '').replace(/(\..*)\.,/g, '$1')">
					</div>
					<div class="form-group">
