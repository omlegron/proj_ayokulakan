						...
						<div class="col-md-6">	
							<div class="form-group">
								...
								<div class="input-group mb-3">
								  ...
								  <input type="text" class="form-control change-money-modals" id="basic-url" aria-describedby="basic-addon3" name="harga_barang" placeholder="Harga Jual Barang" required="" value="{{ $record->harga_barang or '' }}">
								</div>
							</div>
						</div>
						<div class="col-md-6">
