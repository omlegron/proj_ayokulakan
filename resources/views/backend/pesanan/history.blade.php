					...
					<div class="table-responsive">
							...
							<tbody id="body">
								...
								@foreach ($data as $item)
									<tr>
										...
										<td><a href="{{ url("transaksi/confirmation/$item->order_id") }}" data-toggle="tooltip" data-placement="" data-id="{{ $item->id }}" class="ui mini btn btn-sm btn-success button"><i class="fa fa-eye"></i></a></td>
									</tr>
									<?php $no++ ?>
								@endforeach
							</tbody>
						...
						<div class="row " style="margin-top: 35px;">
							<div class="pull-right">
							   {!! $data->links('partials.pagination.frontend-pagination') !!}
							</div>
						</div>
					</div>
				</div>
