...
class TiketPelniController extends Controller
{
    //
    ...
    public function checkPelni(Request $request){
        return $this->render('frontend.home.partial.ppob.11-1', ['request'=>$request->all()]);
    }
