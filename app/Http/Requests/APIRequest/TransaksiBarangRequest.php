...
class TransaksiBarangRequest extends Request
{
    /**
    ...
    public function rules()
    {
        return [
          ...
          'item_details.*.barang.*.price' => 'required',
          'item_details.*.kurir_code' => 'required',
          'item_details.*.kurir_tipe' => 'required',
          'item_details.*.kurir_harga' => 'required|numeric',
          'item_details.*.kurir_hari' => 'required',
